...
namespace backgroundJob.Custom.FileWatcher.EventHandlers
{
	public class ChangedEvent
	{
		...
		public ChangedEvent(FileWatcherDatabase fileWatcherDatabase, Guid pathId, CancellationToken token)
		{
		...
		public FileSystemEventHandler OnChanged => new FileSystemEventHandler(async (obj, e) =>
		{
